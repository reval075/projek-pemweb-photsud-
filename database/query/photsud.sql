...
--
-- Host: localhost:3307
-- Generation Time: May 18, 2026 at 04:07 PM
...
(5, '2026_05_10_182309_create_branches_table', 1),
(6, '2026_05_10_182316_create_booths_table', 1),
(7, '2026_05_10_182329_create_bookings_table', 1),
(8, '2026_05_10_182343_create_sessions_table', 1),
(9, '2026_05_10_182355_create_transactions_table', 1);
...
ALTER TABLE `booths`
  ADD PRIMARY KEY (`id`),
  ADD KEY `booths_branch_id_foreign` (`branch_id`);
...
ALTER TABLE `photo_sessions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `photo_sessions_booth_id_foreign` (`booth_id`);
...
--
ALTER TABLE `booths`
  ADD CONSTRAINT `booths_branch_id_foreign` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `photo_sessions`
--
ALTER TABLE `photo_sessions`
  ADD CONSTRAINT `photo_sessions_booth_id_foreign` FOREIGN KEY (`booth_id`) REFERENCES `booths` (`id`) ON DELETE CASCADE;
